...
def index():
    ...
    ## Buatlah sebuah plot yang menampilkan insight di dalam data pertanyaan bisnis sendiri
    ## Buatlah bar plot dimana axis x adalah nama Content Rating dan axis y adalah jumlah rating pada setiap Content Rating, kemudian urutkan dari jumlah terbanyak
    Top_RatingBy = pd.crosstab(
    ...
    plt.barh(X,Y, color=my_colors)
    # bagian ini digunakan untuk menyimpan plot dalam format image.png
    plt.savefig('Top_RatingBy.png',bbox_inches="tight") 
